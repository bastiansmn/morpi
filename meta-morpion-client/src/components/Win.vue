...
<template>
   <pre class="text-2xl font-bold mb-4">   ______                   __
...
\____/\__,_/\__, /_/ /_/\___/
   ...
   <p>
      <span class="font-bold" v-if="game?.player1?.uuid === game?.winner?.uuid">Gagnant : </span><span class="font-bold">Joueur 1</span> : {{ game?.player1?.username }}
   </p>

   <p class="mb-2">
      <span class="font-bold" v-if="game?.player2?.uuid === game?.winner?.uuid">Gagnant : </span><span class="font-bold">Joueur 2</span> : {{ game?.player2?.username }}
   </p>
